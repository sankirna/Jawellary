...
namespace Jewellery.Web
{
    public static class DatabaseConfig
    {
        ...
        {
            //GoByMobilePortalDbContext goByMobilePortalDbContext = new GoByMobilePortalDbContext();
            //goByMobilePortalDbContext.Database.CreateIfNotExists();

            //// Initialize Membership : Create additional tables if they don't exists.
            //WebSecurity.InitializeDatabaseConnection("GoByMobilePortalDbContext", "User", "Id", "Email", true);
