...
namespace Jeweller.DataAccess.Repository
{
    public interface IDataRepository<T> : IDisposable where T : class
    {
        ...
        /// <summary>
        ///   Find object by  specified expression and return true/false.
        /// </summary>
        /// <param name="predicate"> </param>
        bool Any(Expression<Func<T, bool>> predicate);

        /// <summary>
        /// Find object return true/false.
        /// </summary>
        /// <returns></returns>
        bool Any();
        ...
        /// </summary>
        /// <param name="predicate"></param>
        void LogicalDelete(Expression<Func<T, bool>> predicate);
